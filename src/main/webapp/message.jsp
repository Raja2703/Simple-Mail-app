	...
	<div class="flex w-100% bg-purple-200">
		...
		<div class="w-2/12 px-3 py-6">
			...
			<ul class="leading-6 mt-4">
				<li><a href="getInboxMessages" class="text-lg pl-2 pr-36 py-1 hover:rounded-lg hover:rounded-lg hover:bg-purple-300">Inbox</a></li>
				<li><a href="getSentInbox" class="text-lg pl-2 pr-36 py-1 hover:rounded-lg hover:rounded-lg hover:bg-purple-300">Sent</a></li>
				<li><a href="getTrashInbox" class="text-lg pl-2 pr-36 py-1 hover:rounded-lg hover:rounded-lg hover:bg-purple-300">Trash</a></li>
			</ul>
		</div>
