...
<body>
	...
	<div class="flex w-100% bg-zinc-100">
		<!-- menu -->
		<div class="w-2/12 px-3 py-6 bg-purple-200">
			<a href="compose.jsp"
				class="bg-purple-400 text-white text-xl border border-black rounded-xl py-2 px-4">+
				Compose</a>

			<ul class="leading-6 mt-4">
				<li><a href="getInboxMessages"
					class="text-lg pl-2 pr-36 py-1 hover:rounded-lg hover:bg-purple-300">Inbox</a></li>
				<li><a href="getSentInbox"
					class="text-lg pl-2 pr-36 py-1 hover:rounded-lg hover:bg-purple-300">Sent</a></li>
				<li><a href="getTrashInbox"
					class="text-lg pl-2 pr-36 py-1 hover:rounded-lg hover:bg-purple-300">Trash</a></li>
			</ul>
		</div>

		<!-- sent -->
		<form class="w-10/12 h-screen border-2 rounded-md bg-purple-100"
			action="getMessageServlet" method="post">
			<ul>
				<%
				...
				%>
				<button
					class="w-full p-2 border-b border-gray-300 bg-purple-100 flex hover:bg-purple-200"
					type="submit" value=<%=mid%> name="btn">
					<p class="w-25% mr-4">
						To:
						<%=recepient_email%></p>
